...
#region VAR
	...
	private void Init (int index) 
	{
		...
		data = DataManager.Instance.FoodData;
		SetColorModel();
		rb.velocity = new Vector3(3f, 5f, 1f);
	...
	private void SetColorModel()
	{
		...
		model.GetComponent<Renderer>().material.color = (data.colors[myIndex]);
	}
	...
	void JumpAudio()
	{
		...
		AudioManager.Instance.Play(StaticPrm.AUDIO_FOOD_JUMP);
	}
